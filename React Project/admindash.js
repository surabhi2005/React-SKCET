...
//           <li><button onClick={() => setCategory('men')} style={styles.navButton}>Men</button></li>
//           <li><button onClick={() => setCategory('women')} style={styles.navButton}>Women</button></li>
//           <li><button onClick={() => setCategory('kids')} style={styles.navButton}>Kids</button></li>
//           <li><button onClick={() => setCategory('beauty')} style={styles.navButton}>Beauty</button></li>
//         </ul>
//       </nav>
...
//   },
//   navbar: {
//     backgroundColor: '#7b1fa2', // Darker color for navbar
//     padding: '10px',
//   },
//   navLinks: {
//     display: 'flex',
...
//   },
//   navButton: {
//     backgroundColor: '#a94cc8', // Bootstrap blue for nav buttons
//     color: '#fff',
//     border: 'none',
//     padding: '10px 20px',
//     cursor: 'pointer',
...
//   addButton: {
//     padding: '10px',
//     backgroundColor: '#28a745', // Green button for adding a product
//     color: '#fff',
//     border: 'none',
//     cursor: 'pointer',
//     borderRadius: '5px',
...
//   removeButton: {
//     padding: '5px',
//     backgroundColor: '#dc3545', // Red button for removing a product
//     color: '#fff',
//     border: 'none',
//     cursor: 'pointer',
//     borderRadius: '3px',
...
//           <li><Button onClick={() => setCategory('kids')}>Kids</Button></li>
//           <li><Button onClick={() => setCategory('beauty')}>Beauty</Button></li>
//         </ul>
//       </nav>
