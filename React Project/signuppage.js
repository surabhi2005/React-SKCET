...
function SignUpPage() {
  ...
  return (
    <StyledContainer>
      ...
      <br />
      <IconContainer>
        <OutlinedGoogleButton variant="outlined" startIcon={<GoogleIcon />} onClick={() => navigate('/home')}>
          Sign up with Google
        </OutlinedGoogleButton>
        <OutlinedFacebookButton variant="outlined" startIcon={<FacebookIcon />} onClick={() => navigate('/home')}>
          Sign up with Facebook
        </OutlinedFacebookButton>
      </IconContainer>
      <Typography variant="body2" align="center" paragraph>
        Already have an account?{' '}
        <Link href="/signup" underline="hover" color="primary" onClick={() => navigate('/login')}>
          Sign in
        </Link>
        .
      </Typography>
...
function SignUpPage() {
  ...
  return (
    <StyledContainer>
      ...
      <IconContainer>
        <OutlinedGoogleButton variant="outlined" startIcon={<GoogleIcon />} onClick={() => navigate('/')}>
          Sign up with Google
        </OutlinedGoogleButton>
        <OutlinedFacebookButton variant="outlined" startIcon={<FacebookIcon />} onClick={() => navigate('/')}>
          Sign up with Facebook
        </OutlinedFacebookButton>
      </IconContainer>
      <Typography variant="body2" align="center" paragraph>
...
import { 
  ...
  Box, Link, FormControlLabel, Checkbox 
} from '@mui/material';
import GoogleIcon from '@mui/icons-material/Google';
import FacebookIcon from '@mui/icons-material/Facebook';
import { styled } from '@mui/material/styles';
